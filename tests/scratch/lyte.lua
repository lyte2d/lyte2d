...
function lyte.shaderbuilder_build() return nil end
--- @type  fun(state: lyte.PhysicsState)
function lyte.set_physics_engine() end
...
---@alias lyte.PhysicsState    "off" |  "on" |  "paused"
